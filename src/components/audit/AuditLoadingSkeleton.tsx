  ...
  return (
    <div className="max-w-7xl mx-auto pb-20 p-4 sm:p-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="h-12 w-full sm:w-48 bg-muted rounded-xl animate-pulse" />
      </div>

      {/* Toolbar Skeleton */}
      <div className="h-16 w-full bg-card rounded-2xl border border-border mb-6 p-4 flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {[1, 2, 3].map((i) => (
          ...
          >
            ...
            <div className="h-2 w-full bg-muted/80 rounded animate-pulse" />
          </div>
        ))}
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="h-[400px] bg-card rounded-2xl border border-border p-4 space-y-4">
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={`skeleton-row-${i}`}
