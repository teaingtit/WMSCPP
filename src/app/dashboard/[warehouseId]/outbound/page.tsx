...
import BulkOutboundManager from '@/components/outbound/BulkOutboundManager';
...
export default function OutboundPage() {
  ...
  // Mode state for tabs
  const [mode, setMode] = useState<OutboundMode>('single');
    ...
    <div className="max-w-7xl mx-auto pb-20">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-black text-foreground flex items-center gap-2">
          <div className="p-2 bg-rose-100 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400 rounded-lg">
            <LogOut size={24} />
          </div>
          เบิกจ่ายสินค้า (Outbound Picking)
        </h1>
        <p className="text-muted-foreground ml-12">ค้นหาตำแหน่งสินค้าและตัดสต็อกออกจากระบบ</p>
      </div>
      ...
      {mode === 'bulk' && (
        <div className="mb-8">
          <BulkOutboundManager warehouseId={warehouseId} />
        </div>
      )}
