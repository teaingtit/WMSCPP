      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm animate-in fade-in">
         <form id="create-product-form" action={handleCreate} className="grid grid-cols-1 md:grid-cols-12 gap-5 items-end">
             <div className="md:col-span-3">
                ...
                <input name="sku" required placeholder="A001" className="w-full border border-slate-200 p-2.5 rounded-lg uppercase font-mono text-sm outline-none" />
            </div>
        ...
        <div className="max-h-[500px] overflow-y-auto">
            <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-slate-100">
                    ...
                    {filtered.length === 0 && <tr><td colSpan={5} className="p-8 text-center text-slate-400">ยังไม่มีสินค้าในหมวดนี้</td></tr>}
                </tbody>
            </table>
        </div>
      </div>
