...
async function describeTable(tableName) {
  ...
  `, [tableName]);
    ...
    for (const row of result.rows) {
        ...
        console.log(row.column_name.padEnd(25) +
            dataType.padEnd(20) +
 ...
 */
async function sampleRows(tableName, limit = 10) {
 ...
 */
async function updateRows(tableName, data, whereClause) {
    const columns = Object.keys(data);
    const values = Object.values(data);
 ...
 */
async function deleteRows(tableName, whereClause) {
